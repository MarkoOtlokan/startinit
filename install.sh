...
sudo snap refresh
pip3 install keras tensorflow torch jupyter pandas regex scipy seaborn Flask pyspark peewee sklearn opencv-python peewee python-dotenv websocket torchvision torchsummary segmentation_models_pytorch 
sudo apt autoremove
chsh -s '/usr/bin/fish'
